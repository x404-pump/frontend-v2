...
async function detect$1({ cwd, onUnknown } = {}) {
...
var Nt = (t, e, n) => (n = t != null ? St(At(t)) : {}, $t(
  ...
  e || !t || !t.__esModule ? $$1(n, "default", { value: t, enumerable: !0 }) : n,
  t
));
...
let isColorSupported =
	...
	("FORCE_COLOR" in env ||
		...
		(commonjsRequire != null && require$$1.isatty(1) && env.TERM !== "dumb") ||
		"CI" in env);
...
export { AGENTS as A, CLI_TEMP_DIR as C, INSTALL_PAGE as I, LOCKS as L, UnsupportedCommand as U, parseNi as a, parseNlx as b, parseNu as c, prompts$1 as d, exclude as e, parseNun as f, formatPackageWithUrl as g, c as h, parseNr as i, COMMANDS as j, constructCommand as k, limitText as l, resolveCommand as m, getConfig as n, getDefaultAgent as o, parseNa as p, getGlobalAgent as q, runCli as r, detect as s, getCommand as t, serializeCommand as u, getCliCommand as v, writeFileSafe as w, run as x, remove as y, cmdExists as z };
